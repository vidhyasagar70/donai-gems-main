...
import { FadeScaleAnimation, FadeUpAnimation } from '../ui/FadeUpAnimation'; 
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row items-center gap-8 sm:gap-10 md:gap-12 lg:gap-20 xl:gap-24">
          ...
          <div className="w-full lg:w-5/12 relative mb-16 sm:mb-20 md:mb-24 lg:mb-0">
            ...
            <FadeScaleAnimation delay={0.3} className="absolute bottom-[-40px] right-[-40px] sm:bottom-[-50px] sm:right-[-50px] md:bottom-[-60px] md:right-[-60px] lg:right-[-80px] w-[45%] sm:w-[48%] md:w-[50%] aspect-square">
